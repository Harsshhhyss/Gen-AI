                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4">
                    ...
                    <motion.a
                      ...
                      whileHover={{ scale: 1.03 }}
                      whileTap={{ scale: 0.97 }}
                      className="group flex items-center justify-center gap-2 rounded-full px-10 py-4 sm:px-14 sm:py-5 text-sm sm:text-base font-medium uppercase tracking-widest text-black bg-[#25D366] hover:bg-[#20bd5a] transition-colors w-full sm:w-auto shadow-[0_0_20px_rgba(37,211,102,0.4)]"
                    >
