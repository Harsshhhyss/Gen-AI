...
export const MarqueeSection: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="pt-24 sm:pt-32 md:pt-40 pb-10 bg-background overflow-hidden flex flex-col gap-3">
      {/* Row 1 moves right */}
      <div 
      ...
      >
        {row1.map((src, i) => (
          <img key={i} src={src} alt="Marquee img" className="w-[420px] h-[270px] rounded-2xl object-cover shrink-0" loading="lazy" />
        ))}
      </div>
