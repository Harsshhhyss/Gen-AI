  ...
  return (
    <section id="about" className="min-h-screen flex flex-col items-center justify-center relative px-5 sm:px-8 md:px-10 py-20 bg-background overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 z-10">
        ...
        <AnimatedText 
          text="Founded and led by Harsh Kumar Singh, NextGen AI is a premier technology partner specializing in full-scale SaaS development, cutting-edge AI solutions, and comprehensive digital growth. Serving forward-thinking businesses globally, we engineer high-performance platforms, automate complex workflows, and execute data-driven strategies to establish your market authority."
          className="text-textPrimary font-medium text-center leading-relaxed max-w-[600px] text-[clamp(1rem,2vw,1.35rem)]"
        />
