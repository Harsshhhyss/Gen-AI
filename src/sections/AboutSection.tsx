  ...
  return (
    <section id="about" className="min-h-screen flex flex-col items-center justify-center relative px-5 sm:px-8 md:px-10 py-20 bg-background overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 z-10">
        ...
        <AnimatedText 
          text="Founded and led by Harsh Kumar Singh and Co-founder Viraj Kumbhar, NextGen AI bridges robust technical system architecture with high-end creative strategy to replace guesswork with objective, data-driven execution. We engineer premium digital ecosystems designed to expand your reach and establish market authority."
